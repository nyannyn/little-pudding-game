...
- **待使用者**：畫面簽核（線上網址）；升級變貴（每台 Lv1→2 一律 619，改前爐台 120、烤箱 400；3 小時做出的甜點 600–900→約 350 份）是「同等困難」的直接代價，要先講。已知下一道牆：農場約 3 小時養滿 60 隻，月玩家的收入第 4 天起持平在 23–32 萬／天——長線靠的是離線累積＋機器／人氣兩條升級，農場本身沒有長線。
