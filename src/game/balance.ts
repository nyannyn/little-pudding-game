...
export const BALANCE = {
   ...
   * **按實測泡澡頻率反推的起點**：泡澡約每分鐘一次、本命液一次 +3＝每小時約 180 點。
   * 世代鏈（D63）要一代一代從 ★1 養起：★2（360）→ 下一代 ★3（1,440）→ ★4（4,320）→ ★5（11,520），
   * 一條血統養到 ★5 共 17,640 點≈98 遊戲小時（月玩家一天約 8.75 遊戲小時≈第 11 天）；由月玩家量表（AC11-12）校準。
   * 計畫第一版（30／90／240／600）第 1–2 天就出 ★5，已作廢。
   */
  starCare: [360, 1080, 2880, 7200] as readonly number[],
